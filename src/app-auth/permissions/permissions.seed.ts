  ...
  async seedPermissions() {
    const permissions = [
      ...
      },
      {
        ...
        {
          method: 'GET',
          apiPath: '/api/v1/epik/domains/list/:id',
          name: 'get epik domain list',
          module: 'EPIK',
        },
        {
          method: 'POST',
          apiPath: '/api/v1/epik/update-nameserver/:id',
          name: 'update epik nameserver',
          module: 'EPIK',
        },
        {
          method: 'POST',
          apiPath: '/api/v1/epik/update-nameservers/:id',
          name: 'update epik nameservers (bulk)',
          module: 'EPIK',
        },
        {
          method: 'GET',
          apiPath: '/api/v1/epik/domains/:domain/info/:id',
